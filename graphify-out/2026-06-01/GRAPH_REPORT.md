# Graph Report - fashion-agent  (2026-06-01)

## Corpus Check
- 45 files · ~160,452 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 276 nodes · 396 edges · 23 communities (16 shown, 7 thin omitted)
...
Cohesion: 0.08
Nodes (42): Antigravity Codebase Rules, Form System Architecture Stack, RSC-First Component Rules, Strict TypeScript Standards, Claude Agent References, defaultValues, LoginFormValues, loginSchema (+34 more)

### Community 1 - "Package Configuration & Project Dependencies"
Cohesion: 0.13
Nodes (15): dependencies, clsx, @hookform/resolvers, lucide-react, next, postcss, @radix-ui/react-checkbox, @radix-ui/react-dialog (+7 more)
...
Cohesion: 0.28
Nodes (7): FormRadioGroup(), FormRadioGroupProps, RadioOption, RadioGroup, RadioGroupItem, RadioGroupItemProps, RadioGroupProps
...
Cohesion: 0.05
Nodes (43): 10.1 Route Error Boundaries, 10.2 Typed Error Results, 10.3 `not-found.tsx`, 10. Error Handling, 11. Naming Conventions, 12.1 Path Aliases, 12.2 Import Order, 12.3 Type-Only Imports (+35 more)
...
Cohesion: 0.10
Nodes (17): metadata, metadata, CollectionClient(), Product, PRODUCTS, Navbar(), NavbarProps, ProductDetailClient() (+9 more)
...
## Knowledge Gaps
- **157 isolated node(s):** `NavbarProps`, `metadata`, `metadata`, `loginSchema`, `LoginFormValues` (+152 more)
...
- **Why does `Antigravity — AI Agent Codebase Rules` connect `AI Agent Architectural Guidelines and Form Conventions` to `Community 16`, `Community 17`, `Community 15`, `Multi-line Text Inputs`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Button` connect `Form Components and UI Primitives` to `Standard Home Page Segment`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `cn()` connect `Form Components and UI Primitives` to `Interactive Form Selectors and Layouts`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **What connects `NavbarProps`, `metadata`, `metadata` to the rest of the system?**
