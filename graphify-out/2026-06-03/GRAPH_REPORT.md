...
## Corpus Check
- 58 files · ~169,804 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 319 nodes · 456 edges · 33 communities (26 shown, 7 thin omitted)
...
Cohesion: 0.11
Nodes (27): FormFileUpload(), FormFileUploadProps, FormRadioGroup(), FormRadioGroupProps, RadioOption, FormSelect(), FormSelectProps, SelectOption (+19 more)
...
Cohesion: 0.06
Nodes (32): dependencies, clsx, @hookform/resolvers, lucide-react, next, postcss, @radix-ui/react-checkbox, @radix-ui/react-dialog (+24 more)
...
Cohesion: 0.17
Nodes (10): CreateProductWizardClient(), Step1Media(), Step1MediaProps, Step3Metadata(), Step3MetadataProps, Stepper(), StepperProps, metadata (+2 more)
...
Cohesion: 0.10
Nodes (25): Antigravity Codebase Rules, Form System Architecture Stack, RSC-First Component Rules, Strict TypeScript Standards, Claude Agent References, defaultValues, LoginFormValues, loginSchema (+17 more)
...
## Knowledge Gaps
- **170 isolated node(s):** `NavbarProps`, `ActivityItem`, `FeaturedItem`, `RECENT_ACTIVITIES`, `FEATURED_ITEMS` (+165 more)
...
- **Why does `Button` connect `Form Components and UI Primitives` to `Standard Home Page Segment`, `Community 23`?**
