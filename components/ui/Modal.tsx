        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <DialogPrimitive.Content
            className={cn(
              ...
              "relative w-full bg-white p-6 shadow-[0px_12px_28px_rgba(0,0,0,0.15)] rounded-xl outline-none border border-[#ebebeb]",
          ...
          >
            ...
            <div className="flex flex-col gap-1.5 pr-6">
              <DialogPrimitive.Title className="text-xl font-bold text-[#1a1c1c] tracking-tight">
                {title}
              </DialogPrimitive.Title>
              {description && (
                <DialogPrimitive.Description className="text-sm text-[#5f5e5e]">
                  {description}
            ...
            {/* Main content body */}
            <div className="mt-4 text-[#1a1c1c]">{children}</div>

            {/* Accessible close button */}
            <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 text-[#5f5e5e] hover:bg-[#eeeeee] hover:text-[#1a1c1c] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ff385c]">
              <X className="h-4 w-4" />
